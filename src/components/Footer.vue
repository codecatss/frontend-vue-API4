...
<script>
    ...
    export default {
        ...
        mounted() {
            const toGit = document.getElementById('toGit');
            
            toGit.addEventListener('click', () => {
                window.location.href = 'https://github.com/codecatss/API-BD4';
            });
        }
    }
...
<style>
    ...
    footer {
        width: 100%;
        background-color: var(--oracles-footer-gray);
        padding: 3vh;
